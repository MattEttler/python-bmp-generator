...
def main():
    parser = argparse.ArgumentParser(description='Generate bitmap images. A "rainbow" image is generated by default unless any color value is provided.',
            prog='python-bmp-generator OR python3 -m python-bmp-generator',)
    ...
    parser.add_argument('-r', '--red', type=int, default=0, choices=range(0,256), required=False, metavar='',
            help='the red-value of the image that will be generated within the range 0..255. (default: 0)')
    ...
    parser.add_argument('-b', '--blue', type=int, default=0, choices=range(0,256), required=False, metavar='',
            help='the blue-value of the image that will be generated within the range 0..255. (default: 0)')
